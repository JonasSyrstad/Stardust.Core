...
namespace Stardust.Nucleus
{
    ...
    public interface IBindContext<T> : IBindContext
    {
        ...
        /// <returns></returns>
        IScopeContext ToConstructor(Func<IDependencyResolver, object> creator);
        ...
        /// <returns></returns>
        IScopeContext ToConstructor(Func<IDependencyResolver, object> creator, string identifier);
        ...
        /// <param name="creator">The creator function</param>
        /// <returns></returns>
        IScopeContext ToConstructor(Type type,Func<IDependencyResolver,object> creator);
        /// <summary>
        /// bind the service to the constructor function.
        /// </summary>
        /// <param name="type">The type of object created through the function</param>
        ...
        /// <param name="identifier">Implementation key</param>
        /// <returns></returns>
        IScopeContext ToConstructor(Type type, Func<IDependencyResolver, object> creator, string identifier);
    }
}